...
windows_fore_colors={'black':0x0, 'blue':0x01, 'green':0x02, 'red':0x04, 'inten':0x04, 'reset':0x07}
windows_back_colors={'blue':0x10, 'green':0x20, 'red':0x40, 'inten':0x80}

linux_fore_colors = {'black' : 30, 'red' : 31, 'green' : 32, 'yellow' : 33, 'blue' : 34, 'white' : 37}
linux_back_colors = {'black' : 40, 'red' : 41, 'green' : 42, 'yellow' : 43, 'blue' : 44, 'white' : 47}
...
class linux_stream(object):
    ...
    def out(self, line, fore_color, back_color='black'):
        line = '\033[0;%d;%dm%s\033[0m' % (linux_fore_colors[fore_color], linux_back_colors[back_color], line)
        print(line)
...
class windows_stream(object):
    ...
    def set_color(self, handle, fore_color, back_color=None):
        ...
        if back_color is not None:
            color = color | windows_back_colors[back_color] | windows_back_colors['inten']
