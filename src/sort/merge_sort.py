...
merge_sort_std = [merge_sort_top2down,
            merge_sort_down2top]
            
merge_sort_opt = [merge_sort_top2down,
...
merge_sort_mults = [merge_sort_mult2,
                    merge_sort_mult3,
                    merge_sort_mult4,
                    merge_sort_mult5,
                    merge_sort_mult6,
...
all = [func for l in [merge_sort_std, merge_sort_opt, merge_sort_mults, merge_others] for func in l]